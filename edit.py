...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("Textpro for Python - ver. 0.1")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("Welcome to Textpro")
    # Creating Menubar
  ...
  def openfile(self,*args):
    ...
    try:
      ...
      self.filename = filedialog.askopenfilename(title = "Select file",filetypes = (("All Files","*.*"),("Text Files","*.txt"),("Python Files","*.py"),("FOT Files","*.fot"),("iiOS Files","*.io"),("C# Files","*.cs"),("C Files","*.c"),("Batch Files","*.bat"),("Hyper-text Markup Language Files","*.html"),("JAVA Files","*.java *.jav"),("JSON Files","*.json")))
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Textpro is a simple text editor included with the iiOS")
  ...
  def shortcuts(self):
    ...
    self.txtarea.bind("<Control-Alt-s>",self.saveasfile)
